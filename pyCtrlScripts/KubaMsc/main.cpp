...
data.loadExp({"../expData/1.txt","../expData/1.txt","../expData/1.txt","../expData/1.txt","../expData/1.txt","../expData/1.txt"},0);
data.probeSim({"(0 0 0)","(0.1 0.1 0.1)","(0.2 0.2 0.2)","(0.3 0.3 0.3)","(0.25 0.25 0.25)","(0.5 0.5 0.5)"});
data.trimSimData();
std::array<float,6> sums=data.sumSq();
for (int i=0;i<6;i++){
    std::cout<<sums[i]<<"\n";
}
